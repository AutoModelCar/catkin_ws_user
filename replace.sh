...
sed 's#'$var'#/root/catkin_ws_user#'g $var/odroid-build/.catkin_tools.yaml > $tmpfile
rsync $tmpfile $target/odroid-build/.catkin_tools.yaml

sed 's#'$var'#/root/catkin_ws_user#'g $var/odroid-devel/.catkin > $tmpfile
rsync $tmpfile $target/odroid-devel/.catkin

sed 's#'$var'#/root/catkin_ws_user#'g $var/odroid-devel/setup.sh > $tmpfile
rsync $tmpfile $target/odroid-devel/setup.sh

sed 's#'$var'#/root/catkin_ws_user#'g $var/odroid-devel/.rosinstall > $tmpfile
